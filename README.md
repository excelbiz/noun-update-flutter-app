...
separate Exam Summary checkout, and a grouped directory of website services.
Quizly is excluded from this release.

See **backend/DEPLOY.md** for the website upload and SQL installation steps.
See **docs/mobile_api_v1.md** for the implemented API.
...
The UI uses lightweight custom-painted sculpted icons. News and wallet screens read
real API responses; no demo financial or academic data is shown. Services without
native adapters open their labelled website pages. The existing foundation screens
