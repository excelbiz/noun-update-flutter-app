...
class _NativeNotificationsState extends State<NativeNotifications>{
 ...
 String displayDate(Object? value){final d=DateTime.tryParse('$value');if(d==null)return 'Published update';const months=['Jan','Feb','Mar','Apr','May','Jun','Jul','Aug','Sep','Oct','Nov','Dec'];return '${d.day} ${months[d.month-1]} ${d.year}';}
